  ...
  return (
    <div>
      ...
      <p className="text-center text-gray-500">
        Redesign your existing space with our AI interior redesign tool. Just upload a photo, select a style, and let us do the rest.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-10">
        ...
        <div className="">
          ...
          <p className="text-gray-400 text-sm mb-52 py-1">NOTE: 1 credits will be deducted from your account for every design.</p>
        </div>
      </div>
    </div>
  );
